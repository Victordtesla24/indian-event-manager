      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all sponsors including their name, logo, website and contact information.
          </p>
        </div>
                    ...
                    <tr key={sponsor.id}>
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                        <div className="flex items-center">
                          <div className="h-10 w-10 flex-shrink-0">
                            <img className="h-10 w-10 rounded-full" src={sponsor.logo} alt="" />
                          </div>
                          <div className="ml-4">
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="flex items-center">
                          ...
                          <a href={sponsor.website} className="text-indigo-600 hover:text-indigo-900">
                            {sponsor.website}
                          </a>
                        </div>
                      </td>
                      ...
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a href="#" className="text-indigo-600 hover:text-indigo-900">
                          Edit<span className="sr-only">, {sponsor.name}</span>
                        </a>
                      </td>
                    </tr>
                  ))}
